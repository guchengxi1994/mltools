...
def get_boxex(
    ...
    if front == 1:
        ...
        for o in root4_.iter("object"):
            ...
            if xmax <= imgShape[1] * (1 - widthFactor) or ymax <= imgShape[0] * (
                1 - heightFactor
            ):
                box.find("xmin").text = str(0)
                box.find("xmax").text = str(0)
    ...
    if front == 2:
        ...
        for o in root1_.iter("object"):
            ...
            if (
                ymin >= (1 - heightFactor) * imgShape[0]
                or xmin >= widthFactor * imgShape[1]
            ):
    ...
    if front == 3:
        ...
        for o in root1_.iter("object"):
            ...
            if (
                ymin >= heightFactor * imgShape[0]
                or xmin >= (1 - widthFactor) * imgShape[1]
            ):
                ...
                if ymin < heightFactor * imgShape[0]:
                    if ymax > heightFactor * imgShape[0]:
                        box.find("ymax").text = str(int(heightFactor * imgShape[0]))
    ...
    if front == 4:
        ...
        for o in root1_.iter("object"):
            ...
            if ymin >= heightFactor * imgShape[0] or xmin >= widthFactor * imgShape[1]:
        ...
        for o in root2_.iter("object"):
            ...
            # if ymin >= heightFactor * imgShape[0] or xmax <= imgShape[1] * (
            #         1 - widthFactor):
            if xmax <= imgShape[1] * widthFactor or ymin >= heightFactor * imgShape[0]:
                box.find("xmin").text = str(0)
                box.find("xmax").text = str(0)
                box.find("ymin").text = str(0)
                box.find("ymax").text = str(0)
                ...
                if xmax > imgShape[1] * widthFactor:
                    if xmin < imgShape[1] * widthFactor:
                        box.find("xmin").text = str(int(imgShape[1] * widthFactor))
        ...
        for o in root3_.iter("object"):
            ...
            # if ymax <= (1-heightFactor) * imgShape[
            #         0] or xmin >= widthFactor * imgShape[1]:
            if ymax <= heightFactor * imgShape[0] or xmin >= widthFactor * imgShape[1]:
                box.find("xmin").text = str(0)
                box.find("xmax").text = str(0)
                box.find("ymin").text = str(0)
                box.find("ymax").text = str(0)
